...
function App() {
  ...
  const handleJiraStorySelect = (story: { title: string; description?: string; acceptanceCriteria?: string }) => {
    setFormData(prev => ({
      ...prev,
    ...
    <div>
      <style>{`
        * {
        ...
        /* modal overlay/style for Jira connection form */
        .modal-overlay {
          position: fixed;
          top: 0;
          left: 0;
      ...
      <div className="container">
        ...
        <JiraConnector onStorySelect={handleJiraStorySelect} />
